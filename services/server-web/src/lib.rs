...
use lib_core::{generate_snowflake_id, mysql_pool, ApiResult, AppError, JsonParam};
use lib_entity::fish_record;
use lib_entity::fish_record::Model;
use lib_entity::prelude::FishRecord;
use lib_utils::{Res, ResData};
...
pub async fn init_router(mysql_url: &str) -> Result<Router> {
    ...
    let router = Router::new()
        ...
        .route("/fish_record/list", get(fish_record))
